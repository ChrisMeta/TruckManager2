...
const catalog = [
  ...
  // ECONOHAUL - Budget Brand #1 (Basic, reliable, affordable)
  { brand:'EconoHaul', model:'Workhorse Van', category:'van', fuelType:'diesel', enginePowerKw:110, fuelCapacityL:75, price:28000, speedKph:85,
  ...
  { brand:'EconoHaul', model:'City Cargo', category:'box', fuelType:'diesel', enginePowerKw:150, fuelCapacityL:140, price:65000, speedKph:80,
  ...
  { brand:'EconoHaul', model:'Freight Master', category:'rigid', fuelType:'diesel', enginePowerKw:220, fuelCapacityL:280, price:78000, speedKph:75,
  ...
  // RELITECH - Budget Brand #2 (Slightly better than EconoHaul, focus on durability)
  { brand:'ReliTech', model:'Endurance Van', category:'van', fuelType:'diesel', enginePowerKw:130, fuelCapacityL:85, price:35000, speedKph:90,
  ...
  { brand:'ReliTech', model:'Steadfast Box', category:'box', fuelType:'diesel', enginePowerKw:170, fuelCapacityL:150, price:72000, speedKph:82,
  ...
  { brand:'ReliTech', model:'Hauler Pro', category:'semi', fuelType:'diesel', enginePowerKw:300, fuelCapacityL:350, price:95000, speedKph:85,
  ...
  // THUNDERLINE - Normal Brand #1 (Performance focused, sporty designs)
  { brand:'ThunderLine', model:'Swift Courier', category:'van', fuelType:'diesel', enginePowerKw:160, fuelCapacityL:90, price:48000, speedKph:100,
  ...
  { brand:'ThunderLine', model:'Lightning Box', category:'box', fuelType:'diesel', enginePowerKw:200, fuelCapacityL:170, price:92000, speedKph:88,
  ...
  { brand:'ThunderLine', model:'Storm Hauler', category:'semi', fuelType:'diesel', enginePowerKw:380, fuelCapacityL:420, price:145000, speedKph:92,
  ...
  // GLOBETECH - Normal Brand #2 (Technology focused, efficient designs)
  { brand:'GlobeTech', model:'EcoVan Plus', category:'van', fuelType:'diesel', enginePowerKw:145, fuelCapacityL:80, price:45000, speedKph:95,
  ...
  { brand:'GlobeTech', model:'Smart Cargo', category:'box', fuelType:'electric', enginePowerKw:250, batteryKwh:200, price:115000, speedKph:85,
  ...
  { brand:'GlobeTech', model:'Efficiency Rigid', category:'rigid', fuelType:'diesel', enginePowerKw:280, fuelCapacityL:320, price:105000, speedKph:82,
  ...
  { brand:'GlobeTech', model:'Future Semi', category:'semi', fuelType:'electric', enginePowerKw:450, batteryKwh:480, price:185000, speedKph:87,
  ...
  // APEX MOTORS - Premium Brand (Luxury, high-performance, expensive)
  { brand:'Apex Motors', model:'Prestige Van', category:'van', fuelType:'diesel', enginePowerKw:200, fuelCapacityL:100, price:75000, speedKph:110,
  ...
  { brand:'Apex Motors', model:'Executive Box', category:'box', fuelType:'diesel', enginePowerKw:320, fuelCapacityL:200, price:165000, speedKph:95,
  ...
  { brand:'Apex Motors', model:'Sovereign Rigid', category:'rigid', fuelType:'diesel', enginePowerKw:400, fuelCapacityL:380, price:185000, speedKph:88,
  ...
  { brand:'Apex Motors', model:'Pinnacle Semi', category:'semi', fuelType:'diesel', enginePowerKw:520, fuelCapacityL:500, price:285000, speedKph:98,
